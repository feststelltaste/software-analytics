!function () {
  ...
  u.bP = function () {
    ...
    t.edgeOpacity = function (n) {
      return arguments.length ? (m = n, t)  : 'undefined' != typeof m ? m : 0.4
    },
    ...
    t.bars = function (n) {
      ...
      function o(t, n, e, r, a) {
        ...
        var c = 0.00001 > s ? 0 : (a - r - 2 * t.length * n - u * e) / (s - o),
        d = r,
        f = [
        ];
    ...
    t.mouseover = function (i) {
      ...
      y.selectAll('.subBars').data(u.subBars).transition().duration(t.duration()).attr('transform', function (t) {
        return 'translate(' + t.x + ',' + t.y + ')'
    ...
    t.mouseout = function (i) {
      ...
      y.selectAll('.edges').data(u.edges).transition().duration(t.duration()).style('fill-opacity', t.edgeOpacity()).attr('d', function (t) {
        return t.path
      }),
      y.selectAll('.mainBars').data(u.mainBars).transition().duration(t.duration()).attr('transform', function (t) {
        return 'translate(' + t.x + ',' + t.y + ')'
  ...
  u.gg = function () {
    function t(n) {
      ...
      n.each(function () {
        ...
        d = t.labelLocation(),
        f = t.outerRadius();
        n.append('circle').attr('r', f).style('fill', 'url(#vizgg3' + p + ')').attr('class', 'face'),
        n.append('circle').attr('r', t.innerRadius()).style('fill', 'url(#vizgg2' + p + ')').style('filter', 'url(#vizgg5' + p + ')').attr('class', 'innerFace');
        var l = n.append('g');
        ...
        n.append('g').attr('transform', 'translate(1,1)').selectAll('.needleshadow').data([0]).enter().append('g').attr('transform', 'rotate(' + h + ')').attr('class', 'needleshadow').append('path').attr('d', [
          'm 0',
          - 130 * g,
          5 * g,
          175 * g,
          - 10 * g,
          '0,z'
        ].join(',')).style('filter', 'url(#vizgg6' + p + ')'),
        n.selectAll('.needle').data([0]).enter().append('g').attr('transform', 'rotate(' + h + ')').attr('class', 'needle').append('polygon').attr('points', [
          - 0.5 * g,
          - 130 * g,
          0.5 * g,
          - 130 * g,
    ...
    return t.scale = function () {
      return d3.scale.linear().domain(t.domain()).range([b.startAngle + t.angleOffset(),
      b.endAngle - t.angleOffset()])
    },
    ...
    t.value = function (n) {
      return arguments.length ? (c = n, t)  : 'undefined' != typeof c ? c : 0.5 * (b.domain[0] + b.domain[1])
    },
    t.defs = function (n, e) {
      var r = n.append('defs');
      p = e;
      ...
      u.defs(s).stop().offset('0').stopColor(a),
      u.defs(s).stop().offset('1').stopColor(d3.rgb(a).darker(1));
      var c = u.defs(r).rG().id('vizgg2' + e).fx('35%').fy('65%').r('65%').spreadMethod('pad').sel();
      u.defs(c).stop().offset('0').stopColor(i),
      u.defs(c).stop().offset('1').stopColor(d3.rgb(i).darker(2));
      var d = u.defs(r).rG().id('vizgg3' + e).fx('35%').fy('65%').r('65%').spreadMethod('pad').sel();
      u.defs(d).stop().offset('0').stopColor(o),
      u.defs(d).stop().offset('1').stopColor(d3.rgb(o).darker(2)),
      u.defs(r).lG().id('vizgg4' + e).gradientUnits('userSpaceOnUse').y1('80').x1('-10').y2('80').x2('10').xlink('#vizgg1' + e);
      var f = u.defs(r).filter().id('vizgg5' + e).sel();
      u.defs(f).feFlood().result('flood').floodColor('rgb(0,0,0)').floodOpacity('0.6'),
      u.defs(f).feComposite().result('composite1').operator('in').in2('SourceGraphic') ['in']('flood'),
      u.defs(f).feGaussianBlur().result('blur').stdDeviation('2') ['in']('composite1'),
      u.defs(f).feOffset().result('offset').dy('2').dx('2'),
      u.defs(f).feComposite().result('composite2').operator('over').in2('offset') ['in']('SourceGraphic');
    ...
    t.setNeedle = function (n) {
      ...
      g.selectAll('.needleshadow').data([n]).transition().duration(t.duration()).attrTween('transform', function (t) {
        return e(a, r)
  ...
  u.ch = function () {
    ...
    function s(t) {
      ...
      y = u.valueFormat();
      g.select('path').transition().duration(L).attrTween('d', s),
      g.select('.label').filter(function (t) {
        return 'g' == t.type
    ...
    function f() {
      ...
      h.forEach(function (t) {
        - 1 == m.indexOf(E(t)) && m.push(E(t)),
        - 1 == m.indexOf(M(t)) && m.push(M(t))
      }),
      m = m.sort(T),
      v = {
      },
      ...
      k.forEach(function (n) {
        if (n.subindex == n.index) return n.endStartAngle = n.startAngle,
    ...
    function l(t) {
      ...
      w.forEach(function (n) {
        ...
        n.source !== t && (n.startAngle = n.endAngle, n.endEndAngle = n.endStartAngle)
      })
    }
    function g(t, e, r, a, i) {
      ...
      c.slice(u ? 1 : 0).forEach(function (n) {
        ...
        t[n].endAngle = l + a,
        t[n].padAngle = i,
        t[n].percent = t[n].value / (g || 1),
        l += a + i + (t[n].skipPad ? 0 : e)
      })
    }
    var p,
    h,
  ...
  u.defs = function (t) {
    ...
    n.lG = function () {
      return e = e.append('linearGradient'),
      n
    },
    n.rG = function () {
      return e = e.append('radialGradient'),
      n
    },
    n.stop = function () {
      return e = e.append('stop'),
      n
    },
    n.filter = function () {
      return e = e.append('filter'),
      n
    },
    n.feFlood = function () {
      return e = e.append('feFlood'),
      n
    },
    n.feComposite = function () {
      return e = e.append('feComposite'),
      n
    },
    n.feOffset = function () {
      return e = e.append('feOffset'),
      n
    },
    n.feGaussianBlur = function () {
      return e = e.append('feGaussianBlur'),
      n
    },
    n.result = function (t) {
      return e = e.attr('result', t),
      n
    },
    n.floodColor = function (t) {
      return e = e.attr('flood-color', t),
      n
    },
    n.floodOpacity = function (t) {
      return e = e.attr('flood-opacity', t),
      n
    },
    n.stdDeviation = function (t) {
      return e = e.attr('stdDeviation', t),
      n
    },
    n.operator = function (t) {
      return e = e.attr('operator', t),
      n
    },
    n.height = function (t) {
      return e = e.attr('height', t),
      n
    },
    n.width = function (t) {
      return e = e.attr('width', t),
      n
    },
    n['in'] = function (t) {
      return e = e.attr('in', t),
      n
    },
    n.in2 = function (t) {
      return e = e.attr('in2', t),
      n
    },
    n.id = function (t) {
      return e = e.attr('id', t),
      n
    },
    n.fx = function (t) {
      return e = e.attr('fx', t),
      n
    },
    n.fy = function (t) {
      return e = e.attr('fy', t),
      n
    },
    n.dx = function (t) {
      return e = e.attr('dx', t),
      n
    },
    n.dy = function (t) {
      return e = e.attr('dy', t),
      n
    },
    n.x1 = function (t) {
      return e = e.attr('x1', t),
      n
    },
    n.y1 = function (t) {
      return e = e.attr('y1', t),
      n
    },
    n.x2 = function (t) {
      return e = e.attr('x2', t),
      n
    },
    n.y2 = function (t) {
      return e = e.attr('y2', t),
      n
    },
    n.x = function (t) {
      return e = e.attr('x', t),
    ...
    n.spreadMethod = function (t) {
      return e = e.attr('spreadMethod', t),
      n
    },
    n.gradientUnits = function (t) {
      return e = e.attr('gradientUnits', t),
      n
    },
    n.xlink = function (t) {
      return e = e.attr('xlink:href', t),
      n
    },
    n.offset = function (t) {
      return e = e.attr('offset', t),
      n
    },
    n.stopColor = function (t) {
      return e = e.attr('stop-color', t),
      n
    },
    n.path = function () {
      return e = e.append('path'),
      n
    },
    n.d = function (t) {
      return e = e.attr('d', t),
